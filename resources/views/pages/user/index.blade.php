                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    @if ($user->role == 'ADMIN')
                                        <span
                                            class="badge fw-semibold py-1 w-50 bg-primary-subtle text-primary">{{ $user->role }}</span>
                                    @else
                                        <span
                                            class="badge fw-semibold py-1 w-50 bg-danger-subtle text-danger">{{ $user->role }}</span>
                                    @endif
                                </td>
