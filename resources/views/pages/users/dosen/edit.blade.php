...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Edit Dosen</h2>

            <div class="card">
                <form action="{{ route('users.dosen.update', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <a href="{{ route('users.dosen.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
