...
@section('title', 'Edit Jadwal ' . $staff->name)

@section('main')
<div class="main-content">
    <section class="section">
        <div class="section-header">
           <h1>Edit Jadwal {{ $staff->name }}</h1>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="card">
                <form action="{{ route('schedules.staff.update', [$staff->id, $schedule->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        ...
                        <a href="{{ route('schedules.staff.show', $staff->id) }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
